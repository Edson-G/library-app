...
class ReserveCommand implements LibraryCommand {
  @override
  bool execute(List<String> commandParts) {
    try {
      if (commandParts.isEmpty) {
        throw Exception(
            "Por favor, informe o id do usuário que realizará a reserva e o id do livro desejado.");
      }
      ...
      if (commandParts.length > 2) {
        throw Exception("""Foram informados mais argumentos que o esperado. 
            Por favor, informe apenas o id do usuário que realizará a reserva e o id do livro desejado.""");
      }
      ...
      return system.reserveBookToUser(book, user);
    } catch (exception) {
      print(exception);
      return false;
    }
